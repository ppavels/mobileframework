<?php /* ?>
  ...
  <?php */
$plural='';
if (COUNTRY=='ca'&&$postdata->category_name=='Contest'){$plural='s';}
?>
<section style="margin-top:55px;">

    <div id="container" class=" pad-12 "> 
        <?php /* echo $googleads->SingleHeader; */ ?>
        <div class="cat_title" style='margin-bottom: 10px'> <h1 align="center"><?php echo $postdata->category_name.$plural ?></h1></div>
        <?php $counter = 0; ?>
    ...
    <?php if ($postdata->prevPage && $postdata->prevPage > 1) { ?>
                        <a id="prevPage" href="<?php echo $postdata->categorybase; ?>/<?php echo $postdata->category_slug; ?>/page/<?php echo $postdata->prevPage; ?>/">Previous Page</a> 
            <?php } ?>
    <?php if ($postdata->prevPage && $postdata->prevPage == 1) { ?>
                        <a id="prevPage" href="<?php echo $postdata->categorybase; ?>/<?php echo $postdata->category_slug; ?>/">Previous Page</a> 
    <?php } ?>
    <?php if ($postdata->nextPage) { ?>
                        <a id="nextPage" href="<?php echo $postdata->categorybase; ?>/<?php echo $postdata->category_slug; ?>/page/<?php echo $postdata->nextPage; ?>/">Next Page</a>
            <?php } ?>
